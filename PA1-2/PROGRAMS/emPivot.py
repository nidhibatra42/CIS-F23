...
class EMPivot:
    """A class for working with EMPivot data.

    This class allows you to read and process EMPivot data from a file.

    Attributes:
        numFrames (int): The number of frames in the EMPivot data.
    ...
    def data_setup(self):
        """Read in the EMPivot data and store it in the corresponding arrays
        """  
